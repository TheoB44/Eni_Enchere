...
public class NouvelleVente extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (dateFin != null && !dateFin.isBlank()) {
			...
			/*try {
				dateDeFin = new SimpleDateFormat("yyyy-MM-dd").parse(dateFin);*/
		...
		if(idCategorie > 0 )
		{
			article = new Articles_Vendus(0, nomArticle, description, dateDeb, dateDeFin, prixInitial, 0, idVendeur, idCategorie, null, null, null, null);
