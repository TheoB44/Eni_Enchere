...
public class EncheresDAOJdbcImpl implements EncheresDAO {
	...
	private static final String SELECT_ALL = "SELECT E.montant_enchere, A.nom_article, A.date_fin_enchere, V.pseudo, A.no_utilisateur,A.no_article,A.no_categorie FROM ENCHERES E"
	...
	private static final String SELECT_SEARCH = "SELECT E.montant_enchere, A.nom_article, A.date_fin_enchere, U.pseudo,A.no_article,A.no_categorie FROM ENCHERES E"
			+ " LEFT JOIN ARTICLES_VENDUS A ON A.no_article = E.no_article"
			+ " LEFT JOIN UTILISATEURS U ON U.no_utilisateur = E.no_utilisateur"
			+ " LEFT JOIN CATEGORIES C ON C.no_categorie = A.no_categorie" + " WHERE A.nom_article like ?;";

	private static final String SELECT_SEARCH_ARTICLE = "SELECT E.montant_enchere, A.nom_article, A.date_fin_enchere, U.pseudo,A.no_article,A.no_categorie FROM ENCHERES E"
			+ " LEFT JOIN ARTICLES_VENDUS A ON A.no_article = E.no_article"
			+ " LEFT JOIN UTILISATEURS U ON U.no_utilisateur = E.no_utilisateur"
			+ " LEFT JOIN CATEGORIES C ON C.no_categorie = A.no_categorie" + " WHERE A.nom_article like ?"
			+ " AND C.no_categorie = ?;";
